  ...
  f_N <- function(data, indices) {
    ...
    # v_perc_conv_MTL=sum(d$conv_MCI[d$MTL_pos==1]==1)/sum(!is.na(d$conv_MCI[d$MTL_pos==1]))
    # v_perc_conv_NeoT=sum(d$conv_MCI[d$NeoT_pos==1]==1)/sum(!is.na(d$conv_MCI[d$NeoT_pos==1]))
    v_perc_conv_pMTL=sum(d$conv_MCI[d$MTL_pos==1 & d$plasma_pos==1]==1)/sum(!is.na(d$conv_MCI[d$MTL_pos==1 & d$plasma_pos==1]))
    v_perc_conv_pNeoT=sum(d$conv_MCI[d$NeoT_pos==1 & d$plasma_pos==1]==1)/sum(!is.na(d$conv_MCI[d$NeoT_pos==1 & d$plasma_pos==1]))
    ...
    return(c(100*v_Nplasma[[1]]/v_N0[[1]],#100*v_NMTL[[1]]/v_N0[[1]],100*v_NNeoT[[1]]/v_N0[[1]],
             ...
             p_pMTL_pNeoT,
             100*v_NpMTL[[1]]/v_Nplasma[[1]],100*v_NpNeoT[[1]]/v_Nplasma[[1]]))
    }
  ...
  results_print=data.frame(matrix(nrow = n_method,ncol = 16))
  ...
  for (i_method in 1:length(c_method_plasma)) {
    ...
    for (i_method2 in 1:length(c_method_PET)) {
      ...
      # v_perc_conv_MTL=sum(df$conv_MCI[df$MTL_pos==1]==1)/sum(!is.na(df$conv_MCI[df$MTL_pos==1]))
      # v_perc_conv_NeoT=sum(df$conv_MCI[df$NeoT_pos==1]==1)/sum(!is.na(df$conv_MCI[df$NeoT_pos==1]))
      v_perc_conv_pMTL=sum(df$conv_MCI[df$MTL_pos==1 & df$plasma_pos==1]==1)/sum(!is.na(df$conv_MCI[df$MTL_pos==1 & df$plasma_pos==1]))
      v_perc_conv_pNeoT=sum(df$conv_MCI[df$NeoT_pos==1 & df$plasma_pos==1]==1)/sum(!is.na(df$conv_MCI[df$NeoT_pos==1 & df$plasma_pos==1]))
      ...
      p_perc_pMTL_pNeoT =(1 + sum(!is.na(boot_results$t[,9]) <= 0)) / (nrow(boot_results$t)+1) 
      ...
      ci_perc_plasma0=boot.ci(boot_results, type = "norm",seed=12345,index = 1)
      ...
      ci_perc_pMTL0=boot.ci(boot_results, type = "norm",seed=12345,index = 2)
      ci_perc_pNeoT0=boot.ci(boot_results, type = "norm",seed=12345,index = 3)  
  
      ci_perc_pMTL_plasma=boot.ci(boot_results, type = "norm",seed=12345,index = 10)
      ci_perc_pNeoT_plasma=boot.ci(boot_results, type = "norm",seed=12345,index = 11)  
      ...
      # results_print$N_MTL[i_method]=paste(round(v_NMTL[[1]],0))
      ...
      # results_print$perc_MTL[i_method]=paste(round(100*v_NMTL[[1]]/v_N0[[1]],0),"[",round(ci_perc_MTL0[["normal"]][2]),", ",round(ci_perc_MTL0[["normal"]][3]),"]",sep = "")
      ...
      results_print$perc_plasmaMTL[i_method2]=paste(round(100*v_NpMTL[[1]]/v_N0[[1]],0),"[",round(ci_perc_pMTL0[["normal"]][2]),", ",round(ci_perc_pMTL0[["normal"]][3]),"]",sep = "")
      results_print$perc_plasmaNeoT[i_method2]=paste(round(100*v_NpNeoT[[1]]/v_N0[[1]],0),"[",round(ci_perc_pNeoT0[["normal"]][2]),", ",round(ci_perc_pNeoT0[["normal"]][3]),"]",sep = "")
      results_print$perc_plasmaMTL_plasma[i_method2]=paste(round(100*v_NpMTL[[1]]/v_Nplasma[[1]],0),"[",round(ci_perc_pMTL_plasma[["normal"]][2]),", ",round(ci_perc_pMTL_plasma[["normal"]][3]),"]",sep = "")
      results_print$perc_plasmaNeoT_plasma[i_method2]=paste(round(100*v_NpNeoT[[1]]/v_Nplasma[[1]],0),"[",round(ci_perc_pNeoT_plasma[["normal"]][2]),", ",round(ci_perc_pNeoT_plasma[["normal"]][3]),"]",sep = "")
      ...
      # results_plot$Perc[2]=100*(v_NMTL[[1]])/v_N0[[1]]
      ...
      writexl::write_xlsx(results_plot,path = paste(dir_res,"/Plot_sampleRed_convMCI_power_",v_power0,"_red_",v_redPerc,"_Plasma_",c_method_plasma[i_method],"_PET_",c_method_PET[i_method2],"_Ab_",l_ab,"_adj_",l_adj,"_2steps_20241015.xlsx",sep = ""))
      
    }
    
    writexl::write_xlsx(results_print,path = paste(dir_res,"/SampleRed_convMCI_power_",v_power0,"_red_",v_redPerc,"_Plasma_",c_method_plasma[i_method],"_PET_Ab_",l_ab,"_adj_",l_adj,"_2steps_20241015.xlsx",sep = ""))
