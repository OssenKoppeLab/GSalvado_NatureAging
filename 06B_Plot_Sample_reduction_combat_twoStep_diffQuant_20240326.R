...
for (i_out in 1:length(c_out)) {
  ...
  for (i_method in 1:3) {
    ...
    results_Q2_Q4=readxl::read_xlsx(paste(dir_res,"/Plot_sampleRed_",c_out[i_out],"_Plasma_",c_method_plasma[i_method],"_PET_Q2_Q4_Ab_",l_ab,"_adj_",l_adj,"_power_",v_power,"_change_",v_change,"_proportion_time_4_interval_1.xlsx",sep = ""))
    results_Q3_Q4=readxl::read_xlsx(paste(dir_res,"/Plot_sampleRed_",c_out[i_out],"_Plasma_",c_method_plasma[i_method],"_PET_Q3_Q4_Ab_",l_ab,"_adj_",l_adj,"_power_",v_power,"_change_",v_change,"_proportion_time_4_interval_1.xlsx",sep = ""))
    results_Q4=readxl::read_xlsx(paste(dir_res,"/Plot_sampleRed_",c_out[i_out],"_Plasma_",c_method_plasma[i_method],"_PET_Q4_Ab_",l_ab,"_adj_",l_adj,"_power_",v_power,"_change_",v_change,"_proportion_time_4_interval_1.xlsx",sep = ""))
    ...
    pf2=ggarrange(plot_line+rremove("ylab"),plot_line2+rremove("ylab"),p_PET1+rremove("ylab"),p_PET2+rremove("ylab"),
                  # labels = c("a","","b"),
                  ncol = 4, nrow = 4)
    ggexport(pf2,filename=paste(dir_fig,"/SampleRed_step2_conv_perc_",c_out[i_out],"_Plasma_",c_method_plasma[i_method],"_Ab_",l_ab,"_adj_",l_adj,"_power_",v_power,"_change_",v_change,"_time_4_interval_1.pdf",sep = ""))

    pf2=ggarrange(plot_line+rremove("ylab"),plot_line2+rremove("ylab"),
                  # labels = c("a","","b"),
                  ncol = 3, nrow = 3)
    ggexport(pf2,filename=paste(dir_fig,"/SampleRed_line_perc_",c_out[i_out],"_Plasma_",c_method_plasma[i_method],"_Ab_",l_ab,"_adj_",l_adj,"_power_",v_power,"_change_",v_change,"_time_4_interval_1.pdf",sep = ""))
...
for (i_out in 1:length(c_out)) {
    ...
    results_Q2_Q4=readxl::read_xlsx(paste(dir_res,"/Plot_sampleRed_",c_out[i_out],"_Plasma_Q2_Q4_PET_Q2_Q4_Ab_",l_ab,"_adj_",l_adj,"_power_",v_power,"_change_",v_change,"_proportion_time_4_interval_1.xlsx",sep = ""))
    results_Q3_Q4=readxl::read_xlsx(paste(dir_res,"/Plot_sampleRed_",c_out[i_out],"_Plasma_Q3_Q4_PET_Q3_Q4_Ab_",l_ab,"_adj_",l_adj,"_power_",v_power,"_change_",v_change,"_proportion_time_4_interval_1.xlsx",sep = ""))
    results_Q4=readxl::read_xlsx(paste(dir_res,"/Plot_sampleRed_",c_out[i_out],"_Plasma_Q4_PET_Q4_Ab_",l_ab,"_adj_",l_adj,"_power_",v_power,"_change_",v_change,"_proportion_time_4_interval_1.xlsx",sep = ""))
  ...
  pf2=ggarrange(p_plasma+rremove("ylab"),
                labels = c("a"),
                ncol = 4, nrow = 4)
  ggexport(pf2,filename=paste(dir_fig,"/SampleRed_step1_conv_",c_out[i_out],"_Ab_",l_ab,"_adj_",l_adj,"_power_",v_power,"_change_",v_change,"_time_4_interval_1.pdf",sep = ""))
